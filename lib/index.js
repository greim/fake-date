(function (global, factory) {
  ...
  function fakeDate({
    ...
    class MockDate {
      ...
      getTimezoneOffset() {
        return timezoneOffset === null ? nativeOffsetAt(this.valueOf()) : timezoneOffset;
      }
  ...
  const GET_METHODS = Object.freeze(['getDate', 'getDay', 'getFullYear', 'getHours', 'getMilliseconds', 'getMinutes', 'getMonth', 'getSeconds', 'getYear']);

  const GET_UTC_METHODS = Object.freeze(['getUTCDate', 'getUTCDay', 'getUTCFullYear', 'getUTCHours', 'getUTCMilliseconds', 'getUTCMinutes', 'getUTCMonth', 'getUTCSeconds']);

  const SET_METHODS = Object.freeze(['setDate', 'setFullYear', 'setHours', 'setMilliseconds', 'setMinutes', 'setMonth', 'setSeconds', 'setYear']);

  const SET_UTC_METHODS = Object.freeze(['setUTCDate', 'setUTCFullYear', 'setUTCHours', 'setUTCMilliseconds', 'setUTCMinutes', 'setUTCMonth', 'setUTCSeconds']);

  const PASS_THRU_METHODS = Object.freeze(['getTime', 'setTime', 'toISOString', 'valueOf', 'toGMTString', 'toUTCString', 'toJSON']);

  const DAYS_OF_WEEK = Object.freeze(['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']);

  const MONTHS_OF_YEAR = Object.freeze(['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']);
});